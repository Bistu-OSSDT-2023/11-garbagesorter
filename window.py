...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('垃圾识别系统')
        self.resize(1200, 800)
        self.setWindowIcon(QIcon("images/UI/OIP-C.jpg"))
        # 图片读取进程
        self.output_size = 480
        self.img2predict = ""
        self.origin_shape = ()

        self.model_path = "../checkpoints/resnet50d_pretrained_224/resnet50d_2epochs_accuracy0.99115_weights.pth"  # todo  模型路径
        # 'Harmful','Kitchen','Other','Recyclable'
        self.classes_names = ['Harmful有害垃圾','Kitchen厨余垃圾','Other其他垃圾','Recyclable可回收垃圾']  # todo 类名
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        *** 关于界面 ***
        ...
        about_title = QLabel('欢迎使用基于Pytorch的垃圾识别系统')  # todo 修改欢迎词语
        ...
        label_super.setText("有害垃圾：有害垃圾含有对人体健康有害的重金属、有毒的\n物质或者对环境造成现实危害或者潜在危害的废弃物。\n包括电池、荧光灯管、灯泡、水银温度计、油漆桶、部分家\n电、过期药品及其容器、过期化妆品等。这些垃圾一般使用\n单独回收或填埋处理。\n可回收垃圾：主要包括废纸、塑料、玻璃、金属和布料五大\n类。这些垃圾通过综合处理回收利用，可以减少污染，节省\n资源。\n厨余垃圾：厨余垃圾（上海称湿垃圾）包括剩菜剩饭、骨头、\n菜根菜叶、果皮等食品类废物。经生物技术就地处理堆肥，\n每吨可生产0.6~0.7吨有机肥料。\n其他垃圾：其他垃圾包括除上述几类垃圾之外的砖瓦陶瓷、\n渣土、卫生间废纸、纸巾等难以回收的废弃物及尘土、\n食品袋（盒）。采取卫生填埋可有效减少对地下水、地表水、\n土壤及空气的污染。\n\n")
        label_super.setFont(QFont('楷体', 16))
        label_super.setOpenExternalLinks(True)
        # label_super.setOpenExternalLinks(True)
        label_super.setAlignment(Qt.AlignLeft)
        ...
        self.addTab(about_widget, '垃圾分类小知识')
        # self.setTabIcon(0, QIcon('images/UI/l.png'))
