...
#如果遇到损坏的图像，PIL会直接break，跳出函数，不报错，进行下一个
...
data_path = "C:/Users/20356/Desktop/work/garbage/2023_pytorch110_classification_42-master/garbage_data_split" # todo 数据集路径
# 注： 执行之前请先划分数据集
# 超参数设置
params = {
